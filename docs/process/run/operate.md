...
<!--summary-start-->
_Operating production-level, distributed and federated [EKG/Platform](../../vocab/ekg-platform.md) that serves
...
Operating a production-level, distributed and federated [EKG/Platform](../../vocab/ekg-platform.md) that serves many 
...
- An [EKG/Platform](../../vocab/ekg-platform.md) that complies with agreed levels of service and support
